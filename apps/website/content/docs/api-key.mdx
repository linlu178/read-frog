...
These AI translation services are provided by vendors such as OpenAI, DeepSeek, or Gemini, so you need to apply for an API Key from them and then enter it into our extension.
...
Enter your OpenAI, DeepSeek, or Gemini API Key.
