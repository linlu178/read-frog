...
export const translateProviderNames = ['google', 'microsoft', 'openai', 'deepseek', 'gemini', 'openrouter', 'ollama'] as const satisfies Readonly<
...
export const llmTranslateProviderNames = ['openai', 'deepseek', 'gemini', 'openrouter', 'ollama'] as const satisfies Readonly<
...
// all provider names
export const allProviderNames = ['openai', 'deepseek', 'gemini', 'google', 'microsoft', 'openrouter', 'ollama'] as const satisfies Readonly<
...
export const apiProviderNames = ['openai', 'deepseek', 'gemini', 'openrouter', 'ollama'] as const satisfies Readonly<
